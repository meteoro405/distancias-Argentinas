# ¿A CUÁNTO QUEDA? — Documento de referencia integral v5
...
|---|---|---|---|
| `--bg` | `#F2E8CC` (parch) | `#1C130A` | Fondo de página |
| `--card` | `#FAF4E4` (parch-light) | `#2A1A0A` (ink) | Tarjetas/inputs |
| `--tinta` | `#2A1A0A` (ink) | `#F2E8CC` (parch) | Texto principal |
| `--tinta-2` | `#8A6A50` (ink-lt) | `#D4C080` (parch-dk) | Texto secundario |
| `--linea` | `rgba(160,85,42,.18)` (border) | `rgba(242,232,204,.14)` | Bordes |
| `--acento` | `#A0552A` (leather) | `#C8845A` (bronze-lt) | Links, firma, resultado de costo |
| `--acento-claro` | `#C8845A` | `#E0AC82` | Hover de acento |
