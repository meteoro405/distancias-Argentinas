# ¿A CUÁNTO QUEDA? — Documento de referencia integral v6
...
|---|---|---|---|
| `--bg` | `#E8D880` (parch — **valor real del `body` de De Cuestas, verificado por DevTools en v6**) | `#1E1008` (ink) | Fondo de página |
